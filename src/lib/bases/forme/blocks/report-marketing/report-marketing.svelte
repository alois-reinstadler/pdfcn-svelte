<script lang="ts">
	...
	const sampleMarketingData: BaseReportData = {
		...
		rows: [
			{ label: 'SEO', owner: 'H. Evans', progress: 84, risk: 'Low', status: 'On Track' },
			{ label: 'Paid Search', owner: 'K. Martin', progress: 80, risk: 'Low', status: 'On Track' },
			{ label: 'Lifecycle Email', owner: 'V. Lee', progress: 64, risk: 'Medium', status: 'At Risk' },
			{ label: 'Partner Referrals', owner: 'J. Gomez', progress: 75, risk: 'Medium', status: 'On Track' }
		],
		series: [
			{ label: 'W1', value: 55 }, { label: 'W2', value: 57 }, { label: 'W3', value: 59 },
			{ label: 'W4', value: 60 }, { label: 'W5', value: 62 }, { label: 'W6', value: 63 },
			{ label: 'W7', value: 65 }, { label: 'W8', value: 67 }, { label: 'W9', value: 66 },
			{ label: 'W10', value: 68 }, { label: 'W11', value: 70 }, { label: 'W12', value: 72 }
		],
	...
	let { theme, data = sampleMarketingData }: { theme?: PdfcnTheme; data?: BaseReportData } = $props();
</script>
