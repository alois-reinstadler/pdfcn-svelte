<script lang="ts">
	...
	const sampleData: InvoiceCorporateData = {
		...
		logo: '/favicon.png', notes: 'Corporate billing – Net 30 terms apply. For inquiries, contact accounts@pdfcn.app',
