...
export type GraphStyles = Record<string, Style>;

export const createGraphStyles = (t: PdfcnTheme): GraphStyles => ({
	...
	legendColumn: {
		display: 'flex', flexDirection: 'column', gap: 8, marginLeft: 12, marginTop: 18, minWidth: 120
	},
