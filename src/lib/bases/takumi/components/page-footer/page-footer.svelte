<script lang="ts">
	...
	let { leftText, rightText, centerText, variant = 'simple', background, textColor, marginTop, address, phone, email, website, sticky = false, pagePadding = 0, noWrap = true, style }: Props = $props();
