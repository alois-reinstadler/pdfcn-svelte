		...
		{#if showIcon}
			<View style={styles.iconContainer}>
				<svg width="16" height="16" viewBox="0 0 16 16">
					{#if variant === 'error'}
						<circle cx="8" cy="8" r="7" fill="none" stroke={styles.variantColors.error} stroke-width={ICON_STROKE_WIDTH} />
						<line x1="5.5" y1="5.5" x2="10.5" y2="10.5" stroke={styles.variantColors.error} stroke-width={ICON_STROKE_WIDTH} stroke-linecap="round" />
						<line x1="10.5" y1="5.5" x2="5.5" y2="10.5" stroke={styles.variantColors.error} stroke-width={ICON_STROKE_WIDTH} stroke-linecap="round" />
					{:else if variant === 'info'}
						<circle cx="8" cy="8" r="7" fill="none" stroke={styles.variantColors.info} stroke-width={ICON_STROKE_WIDTH} />
						<circle cx="8" cy="4.5" r="1" fill={styles.variantColors.info} />
						<line x1="8" y1="7" x2="8" y2="11.5" stroke={styles.variantColors.info} stroke-width={ICON_STROKE_WIDTH} stroke-linecap="round" />
					{:else if variant === 'success'}
						<circle cx="8" cy="8" r="7" fill="none" stroke={styles.variantColors.success} stroke-width={ICON_STROKE_WIDTH} />
						<path d="M5 8 L7 10 L11 6" fill="none" stroke={styles.variantColors.success} stroke-width={ICON_STROKE_WIDTH} stroke-linecap="round" stroke-linejoin="round" />
					{:else}
						<path d="M8 1.5 L15 14.5 L1 14.5 Z" fill="none" stroke={styles.variantColors.warning} stroke-width={ICON_STROKE_WIDTH} stroke-linejoin="round" />
						<line x1="8" y1="6" x2="8" y2="10" stroke={styles.variantColors.warning} stroke-width={ICON_STROKE_WIDTH} stroke-linecap="round" />
						<circle cx="8" cy="12.5" r="0.75" fill={styles.variantColors.warning} />
					{/if}
				</svg>
			</View>
		{/if}
